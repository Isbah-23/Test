...
public class VolumeSlider : MonoBehaviour
{
    ...
    private void Load()
    {
        volumeSlider.value = PlayerPrefs.GetFloat("Volume", 1f); // Load the saved volume value from PlayerPrefs
    }
    private void Save()
    {
        PlayerPrefs.SetFloat("Volume", volumeSlider.value); // Save the current volume value to PlayerPrefs
